...
namespace RSDKvRS
{
    public class Tiles128x128
    {
        ...
        /// </summary>
        public Tile128[] BlockList = new Tile128[256];
        ...
        public Tiles128x128(string filename) : this(new RsdkReader(filename))
        {

        }

        public Tiles128x128(System.IO.Stream strm) : this(new RsdkReader(strm))
        {

        }

        public Tiles128x128(RsdkReader strm)
        {
            BlockList = new Tile128[256];
